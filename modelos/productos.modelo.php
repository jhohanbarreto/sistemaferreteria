...
class ModeloProductos{
    ...
    Mostrar Categoria
    ======================================-*/
    static public function mdlMostrarProductos123($tabla, $item, $valor){
        if ($item != null) {
    ...
    static public function mdlIngresarProductos($tabla,$datos){
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, codigo, descripcion, stock, precio_compra,precio_venta, imagen) VALUES (:id_categoria,:codigo,:descripcion,:stock,:precio_compra,:precio_venta, :imagen)");
