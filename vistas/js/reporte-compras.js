...
$(".daterangepicker.opensright.opensright .range_inputs .cancelBtn").on("click", function(){

	localStorage.removeItem("capturarRango3");
	localStorage.clear();
	window.location = "reporte-compras";
})
...
$(".daterangepicker.opensright.opensright .ranges li").on("click", function(){
