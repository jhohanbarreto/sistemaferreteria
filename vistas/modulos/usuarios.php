<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%"><!--width="100%" para no tener problemas con internet expore-->
        <thead>
            ...
            <!-- ENTRADA PARA EL USUARIO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoUsuario" placeholder="Ingresar usuario" id="nuevoUsuario" required> <!--id="nuevoUsuario"->es para que co javascrip restringiremos dos usuarios iguales-->
